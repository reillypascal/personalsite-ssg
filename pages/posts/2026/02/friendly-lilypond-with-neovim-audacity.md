...
Part of what I've been enjoying about text files is that I've gotten [my Neovim setup](https://codeberg.org/reillypascal/nvim) to a place that's very pleasant and smooth to work with. Additionally, I've developed joint issues, and even with a nice vertical mouse, typing exacerbates the joint issues much less.

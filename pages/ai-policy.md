...
I type my blog posts by hand in Neovim, using the built-in spell checker to catch typos. Code is similarly written in Neovim using [this list](https://codeberg.org/reillypascal/nvim/src/branch/main/lua/config/lsp.lua) of language servers to catch errors, and [this collection](https://codeberg.org/reillypascal/nvim/src/branch/main/lua/plugins/conform.lua) of formatting tools to achieve consistent use of line breaks, indentation, etc. — both categories use traditional code parsing, rather than LLMs.
